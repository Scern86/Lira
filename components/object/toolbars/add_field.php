...
<div class="card m-1" id="toolbar">
    <div class="card-header bg-dark">
        ...
        &nbsp;&nbsp;&nbsp; | &nbsp;&nbsp;&nbsp;
        <a href="#" class="btn btn-success" onclick="document.add_field.action='/?com=object&task=add_field&id=<?=$id;?>&type=<?=$type;?>'; document.add_field.submit(); return false;" title="Сохранить и закрыть"><i class="fas fa-save"></i></a>
    </div>
</div>
<script>
$(function() {
