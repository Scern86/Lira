...
<form action="" method="POST" id="edit" name="edit" role="form">
	...
	<div class="card m-1">
		<div class="card-header">
			...
			<strong class="float-right text-warning">Объект <i class="fa fa-pencil-alt"></i></strong></div>			
		<div class="card-body">
...
<p class="text-right"><a class="btn btn-success" href="/?com=object&task=select_field&id=<?=$main->id;?>" title="Добавить"><i class="fa fa-plus"></i> Добавить поле объекта</a></p>
