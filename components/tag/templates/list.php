        ...
        <tbody id="result">
            ...
            <tr>
                ...
                <td class="text-right">
                    ...
                    <a class="btn btn-outline-danger btn-sm" href="/?com=tag&task=remove&id=<?=$item['id'];?>" onClick="return confirm('<?=$text->delete_confirmation?>')" title="<?=$text->remove?>"><i class="fas fa-trash-alt"></i></a>
                </td>
            </tr>
            <?php } ?>
        </tbody>
